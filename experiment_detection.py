...
def experiment(name_frame, name_scene, id_exbl, N=1000, N_supression=0):
    ...
    """
    fname = "res_scenes/{}_{}_{}_{}_{}.npz".format(
        name_frame, name_scene, N, N_supression, "scene"
    )
    if isfile(fname):
        print(fname, "exists")
        return False
    ...
    for i_blood, blood in enumerate([blood_scene, blood_frame, blood_exbl]):
        ...
        fname = "res/{}_{}_{}_{}_{}.npz".format(
            name_frame, name_scene, N, N_supression, names[i_blood]
        )
        np.savez_compressed(
            fname,
            pred_1=pred_1.reshape(anno_scene.shape),
            pred_2=pred_2.reshape(anno_scene.shape),
            anno=anno_scene,
        )
    return True
